...
VALUES ('ae8ed05a-6eef-4f3c-ae27-63b6c8c04314',
       ...
       (NULL, NULL, NOW(), NULL, NULL, NULL, NULL, 'kimthuydoan22082005@gmail.com', NULL, 'FEMALE', 1,
        '{bcrypt}$2a$10$0lvhh4z1X9DR5/6bJUacEux35ayoj1xsVeGIE3IED.e6Gs0.VPSi2', NULL, NULL, NULL, 'kimthuydoan', NULL),
...
VALUES (10000000.00, 'VND', 'VNPay', NOW(), 1),
...
VALUES ('Xe đạp điện Pega Aura 2022 - còn mới 90%', 'Pega', 'Aura', 2022, '18 tháng', NULL, 'Good', 8900000, '68',
       ...
       ('Xe máy điện VinFast Feliz S 2022 - pin thuê', 'VinFast', 'Feliz S', 2022, '20 tháng', NULL, 'Good', 16500000,
        '70', '112', '150', '47000',
        'Bản S, đi lại hằng ngày, khung vỏ còn đẹp, pin đang thuê VinFast (không kèm pin).', 'Thanh Khê, Đà Nẵng',
        FALSE, TRUE, 'APPROVED', TRUE, '2025-10-05 14:05:00', '2025-10-20 09:30:00', NULL, 1, NULL, 1),
...
VALUES ('XYZ123@', 'Ấp Ngô Quyền, xã Bàu Hàm 2, huyện Thống Nhất, tỉnh Đồng Nai', '0796051911', 30000000.000,
       ...
       ('XYZ133@', 'Ấp Ngô Quyền, xã Bàu Hàm 2, huyện Thống Nhất, tỉnh Đồng Nai', '0796051911', 30000000.000,
        1000000.000, 'PENDING', NOW(), 2, 10, 1),
